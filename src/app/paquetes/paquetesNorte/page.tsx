	...
	<div className='relative z-10 flex flex-col items-center'>
			...
			<div className='flex flex-row justify-around items-center w-full mt-10'>
				<div className='flex flex-col'>
					<div className={`text-3xl text-dos-puntos-yellow ${fredoka.className}`}>
						¡Hora de
					</div>
					<div className={`text-2xl text-dos-puntos-yellow font-bold ${alphapipeFont.className}`}>
						viajar al
					</div>
					<div className={`text-2xl text-dos-puntos-yellow font-bold ${alphapipeFont.className}`}>
						NORTE!
				...
				<div className='flex flex-col space-y-2 w-56'>
					<div className='flex flex-row items-center justify-around'>
						<Image src='/Elementos gráficos-12.png' alt='Elemento 1' width={40} height={40} />
						<Image src='/Elementos gráficos-14.png' alt='Elemento 1' width={85} height={50} />
					</div>
					<div className='flex flex-row items-center justify-around'>
						<Image src='/Elementos gráficos-15.png' alt='Elemento 1' width={50} height={40} />
						<Image src='/Elementos gráficos-11.png' alt='Elemento 1' width={40} height={40} />
					</div>
				</div>
			</div>
